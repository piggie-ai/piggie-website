...
const ValuesSection = () => (
  <section id="values" className="values-section bg-gray-50">
    <h2 className="text-4xl font-bold mb-8 text-black">Our Values</h2>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
      <div className="value flex flex-col items-center bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-200 group">
        <svg
